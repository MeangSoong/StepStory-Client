...
export default function Jung () {
    ...
    return (
        <>
            <path 
            id='jung' 
            className={`area_jung ${isHovered ? 'hovered' : ''}`} onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave} onclick={handleonclick}
